...
function removeDashesFromUuids(serviceUuids) {
...
Bleno.prototype.startAdvertising = function(name, serviceUuids, callback) {
  ...
  var undashedServiceUuids = removeDashesFromUuids(serviceUuids);
  this._bindings.startAdvertising(name, undashedServiceUuids);
};

function createIBeaconData(uuid, major, minor, measuredPower) {
...
Bleno.prototype.startAdvertisingAndIBeacon = function(name, serviceData, uuid, major, minor, measuredPower, callback) {
  var iBeaconData = createIBeaconData(uuid, major, minor, measuredPower);
  if (callback) {
    this.once('advertisingStart', callback);
  }
  this._bindings.startAdvertisingAndIBeacon(name, serviceData, iBeaconData);
};
...
Bleno.prototype.startAdvertisingIBeacon = function(uuid, major, minor, measuredPower, callback) {
  ...
  var iBeaconData = createIBeaconData(uuid, major, minor, measurePower);
